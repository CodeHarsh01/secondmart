    ...
    <div>
      <div className='bg-white px-4 sm:px-6 py-4 shadow-md flex justify-between items-center'>
        ...
        <div className='hidden md:flex gap-4 items-center font-medium'>
          <Link href="/" className='hover:-translate-y-1 duration-200 hover:text-blue-600'>Home</Link>
          <Link href="/about" className='hover:-translate-y-1 duration-200 hover:text-blue-600'>About</Link>
          <Link href="/shop" className='hover:-translate-y-1 duration-200 hover:text-blue-600'>Shop</Link>
          <Link href="/T&C" className='hover:-translate-y-1 duration-200 hover:text-blue-600'>Terms and conditions</Link>
          <Link href="/contact" className='hover:-translate-y-1 duration-200 hover:text-blue-600'>Contact</Link>
